...
<div class="content">
				...
				<form class="form" action="Subjectsub.jsp" method="post">
						...
						<label for="">exam Name:</label> <select class="form-control"
							id="ques"  name="se"
							required>
					...
					<div class="row">
					<div class="col-md-12">
						<label for=""> Subject Name </label> <input type="text" name="sn"
							placeholder="Enter Subject Name " class="form-control" required>
					</div>
				...
				<table style="margin-left: 300px;">
					...
					<%
						try {
							...
							out.println(
									"<tr><th>ExamName</th><th>SubjectName</th><th>Discription</th><th>Edit</th><th>Delete</th></tr>");
							...
							if (rt.next()) {
								...
								do {
									out.println("<tr><td>" + rt.getString(1) + "</td><td>" + rt.getString(2) + "</td><td>"
											+ rt.getString(3) + "</td><td><a href=subjectup.jsp?sbn=" + rt.getString(2)
											+ ">Edit   </a></td><td><a href=subjectdele.jsp?sbn=" + rt.getString(2)
											+ ">Delete   </a></td></tr>");
								} while (rt.next());
							} else {

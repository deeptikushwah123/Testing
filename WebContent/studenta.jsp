...
out.println("<tr><th>Name</th><th>DOB</th><th>Address</th><th>Father name</th><th>Batch Time</th><th>Mobile</th><th>Higher Education</th><th>Email</th><th> paper sets</th><th>Password</th><th>Edit</th><th>Delete</th></tr>");				
String q="select * from studentreg ";
...
if(rs.next())
{
		...
		do
		{
 	out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(10)+"</td><td>"+rs.getString(9)+"</td><td><a href=studentupde.jsp?eid="+rs.getString(8)+">Edit   </a></td><td><a href=studentde.jsp?eid="+rs.getString(8)+">X  </a></td></tr>");
		}
		while(rs.next());
		}
else

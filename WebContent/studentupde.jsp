						...
						<div class="collapse navbar-collapse justify-content-end"
							...
							<ul class="nav navbar-nav mr-auto">
								<li class="nav-item"><a href="#" class="nav-link"
									data-toggle="dropdown"> <i class="nc-icon nc-palette"></i>
										<%
								...
								<div class="card-body">
									...
									<%
										try {
											...
											String semail = request.getParameter("eid");
											String q = "select * from studentreg where semail='" + semail + "' ";
									...
									<form class="form" action="studentupde1.jsp" method="post">
										<div class="row">
											<div class="form-group">
												<div class="col-md-6 pl-1">
													...
													<label for="">Student Name</label> <input type="text"
														name="sname" class="form-control" id="ques"
														placeholder="--select topic--" name="st"
														value=" <%out.println(rs.getString(1));%>">
												</div>
												<div class="col-md-6 pl-1">

													<label for=""> Father Name </label> <input type="text"
											...
											<div class="row">
												<div class="form-group">
													<div class="col-md-6 pl-1">
														...
														<label for=""> Dob</label> <input type="text" name="dob"
															class="form-control"
															value=" <%out.println(rs.getString(2));%> ">
													</div>
													<div class="col-md-6 pl-1">
														<label for=""> Mobile no. </label> <input type="text"
															name="mo" class="form-control"
															value=" <%out.println(rs.getString(6));%>">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
													<div class="col-md-6 pl-1">
														<label for=""> Address </label> <textarea rows="4" cols="80"
															name="add" class="form-control"
															value=" <%out.println(rs.getString(3));%>"></textarea>
													</div>

													<div class="col-md-6 pl-1">
														<label for=""> Higher Education </label> <input
															type="text" name="he" class="form-control"
											...
											<div class="row">
												<div class="form-group">
													<div class="col-md-6 pl-1">
														<label for=""> question paper set</label> <select
															class="form-control" id="ques"
															value=" <%out.println(rs.getString(10));%>" name="squ">
															...
															<%
																String qq = "select * from subject ";
																		...
																		if (rt.next()) {
																			do {
																				out.println("<option value=" + rt.getString(1) + ">" + rt.getString(1) + "</option>");
																			} while (rt.next());
																		}
															%>
														</select>
													...
													<div class="col-md-6 pl-1">
														<label for=""> Batch Time </label> <select
															class="form-control" id="ques" name="bt"
											...
											<button type="submit"
												class="btn btn-info btn-fill pull-right" name="btn"
												value="student">save</button>

...
s.setAttribute("idnumber", idno);


String q="select * from question where idquestion='"+idno+" '";
ResultSet rt = DAO.displayRecord(q);
out.println(q);
...
%>
				...
				<form class="form" action="questionup1.jsp" method="post">
					
					<div class="row">
					<div class="form-group">
						<div class="col-md-12">
							<label for="">Select Subject</label>
							<select class="form-control" id="ques"    name="st" value=" <% out.println(rt.getString(8)); %>"  >
...
%>
					...
					<div class="form-group">
						<div class="col-md-12">
							...
							<input type="text" name="qu"  placeholder="Enter Question ." class="form-control"  value=" <% out.println(rt.getString(2)); %> " maxlength="65435">
						</div>
						</div>
						</div>
					<div class="row">
					<div class="form-group">
						<div class="col-md-6 pl-1">
							...
							<input type="text" name="opta"  placeholder="Enter option a" class="form-control" value=" <% out.println(rt.getString(3)); %>" >
						</div>
					<div class="col-md-6 pl-1">
							<label for=""> Option B </label>
							<input type="text" name="optb"  placeholder="Enter option b" class="form-control"  value=" <% out.println(rt.getString(4)); %>" >
						</div>
						</div>
						</div>
					<div class="row">
					<div class="form-group">
						<div class="col-md-6 pl-1">
							...
							<input type="text" name="optc"  placeholder="Enter option c" class="form-control" value=" <% out.println(rt.getString(5)); %>" >
						</div>
						<div class="col-md-6 pl-1">
							<label for=""> Option D  </label>
							<input type="text" name="optd"  placeholder="Enter option d" class="form-control" value=" <% out.println(rt.getString(6)); %>" >
						</div>
						</div>
						</div>
					...
					<div class="form-group">
						<div class="col-md-6 pl-1">
							...
							<input type="text" name="cn"  placeholder="Enter correct  option " class="form-control" value=" <% out.println(rt.getString(7)); %>" maxlength="65435">
						</div>
						</div>
						</div>
